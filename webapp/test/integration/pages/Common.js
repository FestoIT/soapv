sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("com/festo/fiori/apps/so/apv/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#FreeofChargeSalesOrders-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#FreeofChargeSalesOrders-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("com.festo.fiori.apps.so.apv.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["com/festo/fiori/apps/so/apv/localService/mockserver"], function (mockserver) {
