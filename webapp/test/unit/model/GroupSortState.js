sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("BuyerName").length, 1, "The sorting by BuyerName returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by BuyerName and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "NetAmount");

		this.oGroupSortState.sort("BuyerName");
