sap.ui.define([
		...
		return BaseObject.extend("com.festo.fiori.apps.so.apv.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias com.festo.fiori.apps.so.apv.model.ListSelector
			 */
			 ...
			 * @return {com.festo.fiori.apps.so.apv.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
