...
sap.ui.define([
		...
		"com/festo/fiori/apps/so/apv/model/grouper",
		"com/festo/fiori/apps/so/apv/model/GroupSortState"
		...
		return BaseController.extend("com.festo.fiori.apps.so.apv.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("BuyerName", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("com.festo.fiori.apps.so.apv.view.ViewSettingsDialog", this);
			...
			_onMasterMatched :  function() {
				this.getOwnerComponent().oListSelector.oWhenListLoadingIsDone.then(
					function (mParams) {
						...
						var sObjectId = mParams.firstListitem.getBindingContext().getProperty("SoId");
